...
//				JText::_('COM_SEARCH_CIVIEVENT_TITLE_SEARCHES'),
//						'index.php?option=com_search_civievent&view=searches',
//								$vName == 'searches'
//								       );
	...
	public static function getActions()
	{
		...
		$result	= new JObject;
		$assetName = 'com_search_civievent';
