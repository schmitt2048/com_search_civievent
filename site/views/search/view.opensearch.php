 ...
 * @since 1.7
 */
class Search_civeventViewSearch extends JViewLegacy
{
	function display($tpl = null)
	{
		...
		$params = JComponentHelper::getParams('com_search_civievent');
		...
		$searchUri = JURI::base().'index.php?option=com_search_civievent&searchword={searchTerms}';

		// Find the menu item for the search
		$menu	= $app->getMenu();
		$items	= $menu->getItems('link', 'index.php?option=com_search_civievent&view=search');
		if (isset($items[0])) {
